...
You can import a table from a CSV file. Click on the `Import Table` button and select the CSV file you want to import. Botpress will automatically detect the column names and types from the CSV file and create the table for you. 
