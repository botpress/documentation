...
<Callout>
  This flow will be triggered when there's technical issues and irrecoverable errors in the bot. <br />
...
<Callout type="info">
  ...
  ending, alternatively add a Capture card of type Confirmation asking if the user wants to continue the conversation.
  The timeout will be reset and start counting down again. If the user says yes, you can redirect them to the Main flow,
  otherwise you can flow to the End node which will end the conversation.
</Callout>
