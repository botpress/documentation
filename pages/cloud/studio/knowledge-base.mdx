...
<Callout type="info">
  **Limit** <br />
  All Workspaces have a free limit of 100MB Vector Database Storage, which applies to all bots in the Workspace. This amount is equivalent to about 20,000 PDF pages. This amount can be increased. [Learn more](https://botpress.com/pricing)
</Callout>
...
### 1. Check the [Logs](./event-debugger-logs-json/#logs)
...
### 2. Check the [Emulator](./emulator) answers
