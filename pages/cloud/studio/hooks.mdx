...
The Hooks Tab of the Explorer panel allows you to create Hooks. Hooks are custom code snippets that are executed asynchronously when specific events occur in the conversation such as a user or the bot sending a message. They can be customized similarly to Execute Code cards and Validation fields.
