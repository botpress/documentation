...
1. Open up the Flows section and navigate to the **+** icon in the Variables section, situated at the bottom.
...
1. Go into your new workflow(not Main) and create a Variable
