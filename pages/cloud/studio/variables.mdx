...
To create one, simply write: `session.variablename = “Hello World”`

To use a session variable in a text or other card, enclose it in double curly brackets like `{{session.variablename}}`
