...
Botpress also includes different types of variables. These variable types differ in scope or where they can be accessed in your bot's flows. Let's start with the most limited scoped variables and then end with the broadest scoped.
