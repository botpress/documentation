...
- **Summary Max Tokens**: The maximum length of the generated summary in LLM tokens. A token can be a word or a punctuation mark. This parameter allows you to set a limit on how lengthy your summaries can be, ensuring they remain concise and manageable. Goes from 1 to 500. The default value is 100.
- **Transcript Max Lines**: The maximum number of lines (conversation turns) in the transcript. This parameter allows you to set a limit on how lengthy your transcripts can be, ensuring they remain concise and manageable. Goes from 0 (to disable) to 100. The default value is 10.
...
For example, if you wish send the conversation summary to the user, create a Text card and include the summary like this:
