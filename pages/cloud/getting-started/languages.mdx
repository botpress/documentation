...
![Languages](/content/languages-cover.png)
...
![Languages](/content/languages-rewrite.png)

<br />
To automatically translate your chatbot to a different language than it was written in,
