...
| The maximum number of vector database storage available per bot                                                                                                                                   | 100MB      | Vector Database Storage |
| The maximum number of records that can be stored in a table per bot                                                                                                                               | 5,000      | Table Rows             |
| The maximum number of times a bot can be invoked per month                                                                                                                                        | 2,000     | Incoming Messages & Events  |
...
| The maximum number of AI credits that can be used per month (in USD)                                                                                                                              | 5,000      | AI Spend      |
