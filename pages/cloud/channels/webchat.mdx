...
<Callout type="info">
  In simpler terms: 
  - **botpressWebChat** is your toolbox. 
  - **sendEvent** lets you signal the chat. 
  - **sendPayload** lets you send a message to the chatbot. 
  - **configure** lets you set up the chat's behavior. 
  - **mergeConfig** lets you tweak that behavior. 
  - **onEvent** lets you watch and react to things happening in the chat.
</Callout>
