...
For more information on customizing the webchat, please refer to the [Webchat developer documentation](https://botpress.com/docs/developers/webchat/controlling-webchat-using-js/).