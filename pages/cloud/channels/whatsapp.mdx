...
When WhatsApp shares a location it is mapped to the Botpress Location object; hence the best way to capture the WhatsApp location object is using the "Wait for Message" card.

You can access the properties of the location using the below:
