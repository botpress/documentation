...
- Button labels are limited to 20 characters, and dropdown labels are limited to 24 characters.
  - Labels exceeding these limits are automatically truncated. For example, the label "This button label is very long" would become "This button label is" on a button and "This button label is ver" on a dropdown.
