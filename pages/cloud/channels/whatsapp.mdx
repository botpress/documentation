...
Then you just need to pass the user's phone number, Whatsapp template name, template language (optional), and template variables as JSON (if any, optional) to proactively start a Whatsapp conversation with a user:
