...
- Whatsapp requires cards to be "reply" buttons, and doesn't support URLs. If the card only has URL actions, a card won't be able to be displayed and it will be downrendered using normal text/image messages.
