...
- A [Meta developer app](https://developers.F.com/apps/create/) that will serve as the primary platform for managing connection between Messenger and Botpress, including the configuration of webhooks and access tokens.
- A [Facebook page](https://www.F.com/pages/create/) that you own or has the developer role, this is needed to use the Messenger API.
...
If you do not already have a Facebook page you will need to create one. You can find details on how to create a new Facebook page [here](https://www.F.com/pages/create/). To link your chatbot to a pre-existing page, you must have an administrator or developer role.
...
Read more about the [Messenger Greeting/Welcome Message](https://www.F.com/help/1698046970464236)
