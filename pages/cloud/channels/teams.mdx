...
5. Select "Multi Tenant" as the **App type**
...
2. Click the **Developer Portal App** tab in the sidebar, then **_Apps_. Now click the "New app" button**
...
8. The bot is now available in the **Chat** section to all members of your organization!
