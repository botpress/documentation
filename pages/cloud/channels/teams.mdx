...
1. Click on your bot's name
1. Under the **Connect to channels** section, click on **Microsoft Teams**
1. The bot should open in your MS Teams and you can chat with it
