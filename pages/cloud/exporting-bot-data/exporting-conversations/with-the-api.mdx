...
<Callout type="warning">
  ...
  Pagination](https://botpress.com/docs/api-documentation/#pagination). The use of a library like
  [p-retry](https://www.npmjs.com/package/p-retry) to retry requests automatically is also recommended.
</Callout>
...
<Callout type="note">
  The `loadConversations` function will return an object with the properties `conversations` and `meta`. You must push
  the conversations to the existing list and save the token to be used in the next request.
</Callout>
...
#### Formatting the Messages list

Now that you have the list of messages of a conversation it's time to format it so it becomes readable.
