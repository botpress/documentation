...
4.  Store the output in a variable.
...
You could add fixed options or add variables to each choice to make them dynamic. You can also render the list of choices dynamically by toggling the SuperText input and adding an array with the following format:
...
<Callout type="info">
  **Limits** <br/>
 If you add more than 5 choices, they will be rendered as a Dropdown/List instead of buttons. This number may vary by channel. <br/>
