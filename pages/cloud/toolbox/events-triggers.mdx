...
- You can add conditions for firing the trigger using the Edit Filter. Please note : filters are evaluated from the first trigger card created to the last one created. Make sure your conditions are written in consequence.
