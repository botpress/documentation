# Embedding the Web Chat on Wix site 
...
1. Log in to your [**Wix**](https://www.wix.com) dashboard.
2. Go to **Settings** from the left sidebar.
3. Scroll down to **Advanced Settings** and click on **Custom Code**.
5. Click on **+ Add Code** in **Body - Start** and paste the **Embedded** script you copied from the **Pre-configured** tab in the **Botpress** dashboard.
9. Ensure you apply the code to **All pages** and load the code **Once** at the **Body - end** tag and click **Apply**.
