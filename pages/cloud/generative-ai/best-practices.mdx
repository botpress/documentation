...
![Shortcuts](/docs/generative-ai-best-practices-cover.png)
...
![Shortcuts](/docs/kevin-hart-personality.png)

Or **"Act like a Teacher"**

![Shortcuts](/docs/teacher-personality.png)
