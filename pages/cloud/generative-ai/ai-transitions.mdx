...
![Shortcuts](/content/generative-ai-transitions-cover.png)
...
```html
“If the customer asks about the status of their order, transition to the node with current shipping status and estimated
delivery date.”
```
