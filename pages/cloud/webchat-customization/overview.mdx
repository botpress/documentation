...
![Styling Webchat](/docs/content/webchat-styling-cover.png)
...
We have a tool dedicated to styling the bot and uploading the stylesheet. [link](https://styler.botpress.app)
You can use this tool for quickly setting up the style of your bot. Additionally, if you want to do something more advanced, you can read the following instructions, and use the styler tool for uploading & hosting the resulting stylesheet.
