...
![Styling Webchat](/content/webchat-styling-cover.png)
...
<Callout type="info">
  **Note**
  <br />
  To add your own CSS styling, you must upload your CSS file to your server and add it's url to the **stylesheet**
  parameter.
</Callout>
<br />
The configuration object passed to the **`.init()`** accepts the following available options which you can pass to
