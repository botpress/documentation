...
The Knowledgebase Vector Count section shows the number of vectors in the chatbot's Knowledgebase and the limit. It accounts for the total number of vectors (condensed pieces of your content) in all of your [Knowledgebase](../studio/knowledge-base) documentsm as well as searchable columns in your tables.
