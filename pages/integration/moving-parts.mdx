...
The standard way to develop a chatbot on Botpress Cloud is to use the [Studio](studio.botpress.cloud). It is a low-code platform; that is, the Studio allows you to create chatbots by writing little code, or even none at all.
