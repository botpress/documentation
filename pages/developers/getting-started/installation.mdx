...
Building integrations in Botpress is an easy and powerful way to extend Botpress or improve the bot building experience. 
...
The npm run start command will ask you to select a workspace to deploy the integration to. You can select an existing workspace or create a new one.
