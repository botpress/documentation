...
# Adding Channel Capabilities

In this section, we'll extend your existing integration to send and receive text messages to Telegram. We'll also create a bot to test it out. 
