...
const fileUrl = response.file.url // Will contain the public URL of the file if it was created with the 'public_content' access policy, otherwise it will contain a temporary pre-signed URL.
```
